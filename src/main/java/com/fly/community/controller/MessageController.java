...
import com.fly.community.service.MessageService;
...
import static com.fly.community.event.NewsConstants.*;
...
//    }
    ...
    public String getMailList(Model model, Page page) {
        ...
        if (conversationList != null) {
            for (Message message : conversationList) {
                ...
                map.put("letterCount", messageService.countMails(message.getConversationId()));
    ...
    public String getMails(@PathVariable("conversationId") String conversationId, Model model, Page page) {
        page.setLimit(5);
        page.setPath("/message/detail/" + conversationId);
        page.setRows(messageService.countMails(conversationId));

        List<Message> letterList = messageService.findMails(conversationId, page.getOffset(), page.getLimit());
