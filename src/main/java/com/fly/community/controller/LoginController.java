...
public class LoginController {
    ...
    public String login(String username, String password, String validationCode, boolean rememberMe, Model model, HttpSession session, HttpServletResponse response) {
